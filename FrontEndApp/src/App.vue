...
export default {
  ...
  methods: {
    systemClose: function () {
      window.browserWindow.systemClose();
    },
    systemMinimize: function () {
      window.browserWindow.systemMinimize();
    },
    systemMaximize: function () {
      window.browserWindow.systemMaximizeToggle();
    }
  }
}
</script>
